...
export default class CreateRungis extends Component {
    constructor(props) {
        super(props);
        this.onChangeRungisDateLibelle =
            this.onChangeRungisDateLibelle.bind(this);
        this.onChangeRungisCodeLibelle =
            this.onChangeRungisCodeLibelle.bind(this);
    ...
    onSubmit(e) {
        ...
        axios
            .post(`http://localhost:4000/rungis/create`, userObject)
            .then((res) => {
            ...
            <div>
                ...
                >
                    ...
                    <div className="form-group">
                        <input
                            type="text"
                            value={this.code_libelle}
                            onChange={this.onChangeRungisCodeLibelle}
                            placeholder={'CodeLibelle'}
                    ...
                    <div className="form-group">
                        <input
                            type="text"
                            value={this.libelle}
                            onChange={this.onChangeRungisLibelle}
                            placeholder={'Libelle'}
                            className="form-control"
                            style={{ width: '100px' }}
                        />
                    ...
                    <div className="form-group">
                        ...
                        >
                            <input
                                type="number"
                                step={0.01}
                                value={this.prix_mini}
                                onChange={this.onChangeRungisPrixMin}
                                placeholder={'min'}
                                className="form-control"
                                style={{ width: '90px' }}
                            />
                        ...
                        >
                            <input
                                type="number"
                                step={0.01}
                                value={this.prix_maxi}
                                onChange={this.onChangeRungisPrixMax}
                                placeholder={'max'}
                                className="form-control"
                                style={{ width: '90px' }}
                            />
                        ...
                        >
                            <input
                                type="number"
                                step={0.01}
                                value={this.prix_moyen}
                                onChange={this.onChangeRungisPrixMoyen}
                                placeholder={'moyen'}
                                className="form-control"
                                style={{ width: '90px' }}
                            />
                    ...
                    <div className="form-group">
                        <input
                            type="text"
                            value={this.unite_prix}
                            onChange={this.onChangeRungisUnitePrix}
                            placeholder={'Unité Prix'}
                            className="form-control"
                            style={{ width: '100px' }}
                        />
                    </div>
